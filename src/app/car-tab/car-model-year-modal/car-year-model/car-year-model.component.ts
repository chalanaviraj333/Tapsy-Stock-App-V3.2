...
@Component({
  selector: 'app-car-year-model',
  templateUrl: './car-year-model.component.html',
  styleUrls: ['./car-year-model.component.scss'],
})
export class CarYearModelComponent implements OnInit {
